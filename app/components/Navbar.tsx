...
const Navbar = () => {
  ...
  <div className={`items-center bg-transparent ${textColor}`}>
    <IoSearchOutline className='sm:w-[35px] sm:h-[35px] w-[25px] h-[25px]' />
  </div>
  <div className={`bg-transparent ${textColor}`}><p className='font-nature sm:text-4xl text-xl'>Ectore</p></div>
  <div className={`bg-transparent flex items-center flex-row gap-4 ${textColor}`}>
    <RiShoppingCart2Line className='sm:w-[35px] sm:h-[35px] w-[25px] h-[25px]' />
    <CgProfile className='sm:w-[35px] sm:h-[35px] w-[25px] h-[25px]' />
  </div>
</header>
  )
}
