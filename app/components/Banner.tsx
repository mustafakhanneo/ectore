  ...
  const banner = [
    {
      ...
      description:
        "Step into Summer with Style! Discover our vibrant Summer Collection, where lightweight fabrics, bright colors, and trendy designs come together to keep you cool and chic all season long. Shop now and refresh your wardrobe with the latest summer essentials!",
    },
    {
      url: "https://picsum.photos/1500/600",
      title: "Winter Collection",
      description:
        "Embrace the Chill in Elegance! Explore our Winter Collection, featuring cozy knits, luxurious layers, and sophisticated styles to keep you warm and fashionable. From snug sweaters to stylish coats, find everything you need to stay stylish this winter.",
    },
    {
      url: "https://picsum.photos/1500/600",
      title: "Exclusive Collection",
      description:
        "Experience Luxury with our Exclusive Collection! Indulge in unique, high-end pieces crafted with exquisite attention to detail. Perfect for making a statement, our exclusive line offers the ultimate in fashion and sophistication. Elevate your style with these timeless pieces.",
    },
    {
      url: "https://picsum.photos/1500/600",
      title: "Limited Collection",
      description:
        "Don't Miss Out on Our Limited Collection! Discover rare and unique pieces available for a short time only. Each item in this collection is designed to stand out and is perfect for those who love to wear something truly special. Shop now before they're gone!",
    },
  ];
